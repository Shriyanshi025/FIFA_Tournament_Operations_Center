...
interface AccessibilityStyleProps {
...
export function AccessibilityStyle({ a11yLargeText, a11yHighContrast, a11yReducedMotion, a11yColorblindMode }: AccessibilityStyleProps) {
  return (
    <style>{`
      ${a11yLargeText ? `
